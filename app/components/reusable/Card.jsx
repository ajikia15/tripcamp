...
export default function Card ({
  ...
  const next = () =>
    ...
    <div className="overflow-hidden relative rounded-md">
      {/* <a href="listings/1"> */}
        <div className="flex transition-transform ease-out duration-1000 object-contain" style={{transform: `translateX(-${curr * 100}%)`}}>
          {slides}
        </div>
        <div className="opacity-0 hover:opacity-100 hover:transition hover:duration-500 hover:ease-in-out absolute inset-0 text-white flex items-center justify-between p-4">
