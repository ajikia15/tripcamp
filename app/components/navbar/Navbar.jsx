  ...
  return (
    !pathname.includes("/gall") && (
      <>
        ...
        />
        <div
          className={`fixed top-0 left-0 z-20 w-full bg-white shadow-sm ${
            pathname == "/successpayment" || pathname == "/rejectpayment"
              ? "hidden"
              : ""
          }`}
        >
          ...
          {!isMobile ? (
            <div
              className={`w-full  bg-white z-40 opacity-0 md:opacity-100 grid grid-cols-1 divide-x ${"h-[3rem] md:h-[5.5rem] xl:h-[6rem"}`}
            >
