...
const Pagination = ({
  ...
  return (
    <div className="sticky bottom-0 left-0 right-0 grid col-span-1 py-3 bg-white sm:col-span-2 lg:col-span-3 xl:col-span-4">
      <div className="flex items-center justify-center w-full gap-4">
        {currentPage > 1 ? (
          ...
          <div className="grid w-12 text-gray-600 opacity-0 aspect-square place-items-center">
            a
          </div>
        )}
        ...
        {startPage > 1 && (
          <>
            <button
              ...
              className="grid w-12 text-gray-900 aspect-square place-items-center"
            >
              1
            </button>
