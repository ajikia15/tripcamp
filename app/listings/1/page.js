    ...
    return (
        <div className="w-4/5 mx-auto">
            ...
            <div className="flex flex-row mt-12 mb-4 items-center">
                <div className="flex flex-col gap-y-4 border-b-2 pb-4 w-4/5">
            ...
            <div className="w-4/5">
                ...
                <div className="grid grid-cols-1 grid-rows-2 md:grid-cols-2 md:grid-rows-1 border-b-2 pb-2 mb-4">
                    <div className="">
                ...
                <h2 className="hidden sm:hidden md:block lg:block text-xl mb-4">
                    {" "}
                    List Title{" "}
                </h2>
            </div>
            <div className="hidden md:block mb-4 border-b-2 pb-4 w-4/5">
            ...
            <div>
                ...
                <div className="flex flex-row items-center gap-x-5 pb-4 border-b-2 mb-4">
                    <div className="bg-gray-800 rounded-full w-16 h-16 text-white text-xs flex items-center justify-center">
                        {" "}
                        Img{" "}
                    </div>
                    <div>
            ...
            <div className="mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 md:gap-x-24 lg:gap-x-32 text-sm">
